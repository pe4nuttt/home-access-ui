            ...
            <nav className={cx('navbar')}>
                <div className={cx('container')}>
                    <Link to="/" className={cx('logo')}>
                        HAccess
                        <FontAwesomeIcon icon={faTypo3} onClick={closeMobileMenu} />
                    </Link>
                    ...
                    {!isAuth && button && (
                        <Button to="/auth/sign-in" buttonStyle="btn--primary">
                            SIGN IN
                        </Button>
                    )}
                    {isAuth && button && (
                        <Button to="/" buttonStyle="btn--primary" onClick={handleSignOut}>
                            SIGN OUT
                        </Button>
                    )}
                </div>
